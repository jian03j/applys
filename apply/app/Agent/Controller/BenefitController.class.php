...
class BenefitController extends AgentbaseController {
    ...
    public function set_agent_post_with_benefit() {
        ...
        if ($benefit_type == 1) {
            ...
            // exit;
            // }
            if (!(($data['first_mem_rate'] > $hs_br_obj->mem_rate_bottom && $data['first_mem_rate'] <= $hs_br_obj->mem_rate_top) && ($data['mem_rate'] > $hs_br_obj->mem_rate_bottom && $data['mem_rate'] <= $hs_br_obj->mem_rate_top))) {
                $this->ajaxReturn(
                        array(
                            "error" => "1", 
            ...
            if (!(($data['first_mem_rebate'] > $hs_br_obj->mem_rebate_bottom && $data['first_mem_rate'] <= $hs_br_obj->mem_rebate_top) && ($data['mem_rebate'] > $hs_br_obj->mem_rebate_bottom && $data['mem_rebate'] <= $hs_br_obj->mem_rebate_top))) {
                $this->ajaxReturn(
                        array(
                            "error" => "1", 
