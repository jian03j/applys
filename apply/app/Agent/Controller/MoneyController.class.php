...
use Agent\Controller\FinanceController;
...
//        $amount=$pay_data['money'];
    ...
    public function recharge_balance(){
        ...
        //$members=$this->getMyMembers($this->agid);
	//var_dump($this->user_type);exit;
	
	//$this->assign('user_types',$this->user_type);
        $this->display();
    }
