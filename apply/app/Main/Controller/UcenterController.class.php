...
//        print_r($_SESSION);
    ...
    public function addSub_post(){
        if(I('post.user_login')&&I('post.name')&&I('post.phone')&&I('post.email')&&I('post.pass')){
            ...
            $result=$this->Huosdk_agent->createSubAgent(I('post.user_login'),I('post.phone'), I('post.pass'), I('post.name'), I('post.email'));
            if($result=="1"){
    ...
    public function editSub_post(){
        if(I('post.subid')&&I('post.name')&&I('post.phone')&&I('post.email')){
            ...
            $result=$this->Huosdk_agent->editSubAgentInfo(I('post.subid'),I('post.phone'), I('post.name'), I('post.email'));
            if($result=="1"){
