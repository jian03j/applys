...
// 代理配置文件引入
if (file_exists(SITE_PATH . "conf/apply/config.php")) {
    $agent_config = include SITE_PATH . "conf/apply/config.php";
} else {
    $agent_config = array();
}
...
$configs = array(
    ...
    'SP_ADMIN_STYLE'		=> 'flat',
    'SP_ADMIN_TMPL_PATH'    => SITE_PATH.'apply/themes/',       // 各个项目后台模板文件根目录
...
return array_merge($configs, $routes, $db, $agent_config, $runtime_config,$alipay_config,$company_config,$setting_config);
